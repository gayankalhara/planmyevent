                            ...
                            <div class="form">
                                <form class="form-horizontal" id="" method="post" action="approve-quote" >
                                	<div class="form-group ">
                                        ...
                                        <div class="col-lg-9">
                                            <input class=" form-control" id="id" name="id" type="text" value="@foreach( $result as $quote){{$quote->id}}
                                            					@endforeach" readonly>
                                        </div>
                                    </div>
									<div class="form-group ">
                                    ...
                                    <div class="form-group " id="divTask">
                                        ...
                                        <div class="col-lg-9">
											<input class="form-control" type="text" name="task" value="{{$services}}" readonly>
                                        </div>
                                    </div>
                                    <br/>
                                    <h4>EVENT DETAILS</h4> 
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-9">
                                                <input id="eventtime" name="eventtime" type="text" class="form-control" value="@foreach( $result as $quote){{$quote->FirstName}}
                                            					@endforeach" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-offset-4 col-lg-8">
                                            ...
                                            <button class="btn btn-default waves-effect" type="button">Reject</button>
                                        </div>
                                    </div>
                                {!! csrf_field() !!}
                                </form><!-- .form -->
