                                                                    ...
                                                                    <tbody><tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%;">
                                                                                ...
                                                                                <h1 style="color: #6B6B6B; text-align: center;">Quote Rejected</h1>


                                                                                <h3 style="color: #6B6B6B; text-align: center;">Your Quote Request with the QuoteID {{$quoteID}} has been Rejected</h3>
                                                                                <h3 style="color: #6B6B6B; text-align: center;">Reason: {{$reason}}</h3>
                                                                                <p style="color: #7B7B7B;">Message: {{$msg}}</p>
