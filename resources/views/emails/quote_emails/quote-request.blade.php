                                                                    ...
                                                                    <tbody><tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%;">
                                                                                ...
                                                                                <h1 style="color: #6B6B6B; text-align: center; line-height: 120%;">Quote Requested Successfully</h1>


                                                                                <h3 style="color: #6B6B6B; text-align: center;">Your Quote Request was successful and it is being reviewed by one of our Event Planner.</h3>
                                                                                <h3 style="color: #6B6B6B; text-align: center;">QuoteID: {{$quoteID}}</h3>
