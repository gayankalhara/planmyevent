                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                                    {{$FirstName}} , Your {{$EventType}} Event is Ready! 
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                                    ...
                                                                                                    <tbody><tr>
                                                                                                            <td valign="top" class="textContent">
                                                                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%;">
                                                                                                                    ...
                                                                                                                    <h1 style="color: #6B6B6B; text-align: center;">{{$FirstName}} 's Event is Complete </h1>
                                                                                                                               <h5>Event Date is {{$DueDate}} </h5>
                                                                                                                                <h5>Completed On {{$CompletedOn}} </h5>
                                                                                                                               <h6> follow link to view status : <a href="http://www.planmyevent.me/dashboard/events/progress?EventID={{$EventID}}">Click Here</a> </h6>
