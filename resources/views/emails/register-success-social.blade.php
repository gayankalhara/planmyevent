                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" class="textContent">
                                                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                                    Thank you for registering with PlanMyEvent.me
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                                    ...
                                                                                                    <tbody><tr>
                                                                                                            <td valign="top" class="textContent">
                                                                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%;">
                                                                                                                    ...
                                                                                                                    <h1 style="color: #6B6B6B; text-align: center;">Welcome to PlanMyEvent.me</h1>


                                                                                                                    <h3 style="color: #6B6B6B; text-align: center;">Thank you for registering with us.</h3>
                                                                                                                    <p style="color: #7B7B7B;">A new account was created for you. You may now login using {{ $provider }} or using following login details.</p>
                                                                                                                    
                                                                                                                    <p style="color: #7B7B7B;"><strong>Email Address: </strong> {{ $email }}</p>
                                                                                                                    <p style="color: #7B7B7B;"><strong>Password: </strong> {{ $pwd }}</p>
                                                                                                                    
                                                                                                                    <p style="color: #7B7B7B;">Please change the password of your account as soon as possible.</p>

                                                                                                                    <a href="http://www.planmyevent.me/login">Click here to login</a>
