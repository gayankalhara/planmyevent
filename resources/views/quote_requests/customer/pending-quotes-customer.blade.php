...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center><h3 class="page-title">Pending Quote Requests</h3></center>
                </div>
            </div>
            <br/>
            <div class="row">
                                ...
                                <form class="form-horizontal" id="" method="post" action="approve-quote" >
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-offset-5 col-lg-5">
                                            <a href="{{ url('dashboard/view-quote-requests') }}"><button class="btn btn-default waves-effect" type="button">Go Back</button></a>
                                        </div>
                                    </div>
                                    {!! csrf_field() !!}
                                </form><!-- .form -->
