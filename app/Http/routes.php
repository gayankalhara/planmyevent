...
/*
|--------------------------------------------------------------------------
| Routes that are available only for Adminstrators
|--------------------------------------------------------------------------
*/
Route::group(['middleware' => ['web', 'App\Http\Middleware\AdminMiddleware']], function () {
    ...
    */
        ...
        Route::post('dashboard/feedback', 'CoreController@Feedback');
        Route::get('dashboard/feedback', 'CoreController@Feedback');
        Route::post('dashboard/feedback/add', 'CoreController@AddFeedback');
        Route::get('dashboard/feedback/add', 'CoreController@AddFeedback');
        Route::get('dashboard/viewfeedback', 'CoreController@ViewFeedback');
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Generate Data Migration Files from MySQL Database
    |--------------------------------------------------------------------------
    */
...
/*
|--------------------------------------------------------------------------
| Routes that are only accessible by Customers 
...
Route::group(['middleware' => ['web', 'App\Http\Middleware\CustomerMiddleware']], function () {
    Route::get('dashboard/request-a-quote', 'hjController@LoadRequestQuote');
